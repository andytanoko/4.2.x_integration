...
var BgColor="white"; //Background color of Calendar window
var MonthYearBgColor="#4682B4"; //Background color of Calendar header
var BorderCol="#4682B4"; //Border color of calendar table contents
...
function RenderCal()
{
	...
	docCal.writeln("</head><body background='"+ThemeBg+"' bgcolor="+BgColor+" link="+FontColor+" vlink="+FontColor+"><form name='Calendar'>");

	vCalHeader="<table border=1 bordercolor=\""+BorderCol+"\" cellpadding=1 cellspacing=1 width='100%' align=\"center\" valign=\"top\">\n";
...
function GenCell(pValue,pHighLight,pColor)//Generate table cell with value
{
  ...
  if (PValue=="")
    ...
    vPValueStr="<a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+Cal.FormatDate(PValue)+"';"+vTimeStr+";window.close();\">"+PValue+"</a>";
    
	PCellStr="<td "+vColor+" width="+CellWidth+" align='center'><font face='verdana' size='2'"+vHLstr1+vPValueStr+vHLstr2+"</font></td>";
	return PCellStr;
}
