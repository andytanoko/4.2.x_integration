...
VALUES (-1,NULL,NULL,1,NULL,NULL,'UserProcedure',NULL,NULL,0,LOCALTIMESTAMP(0),NULL,-1,1,NULL,0,CURRENT_DATE,NULL,NULL,'CHECK_CERT_EXPIRY_PROC');
...
VALUES (-1,1,NULL,NULL,NULL,NULL,NULL,NULL,LOCALTIMESTAMP(0),NULL,NULL,NULL,NULL,NULL,NULL,'BEGIN:VEVENT'||chr(13)||chr(10)||'RRULE:FREQ=DAILY'||chr(13)||chr(10)||'END:VEVENT',NULL);
