...
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;../server/default/lib/xerces-2.4.0.jar;../server/default/lib/xml-parser-apis.jar
...
rem set JAXP=%JAXP% -Djava.io.tmpdir=%GRIDTALK_HOME%/temp
set JAVA_OPTS=%JAVA_OPTS% %JAXP% -Xms128m -Xmx512m
