...
#TCLASSPATH=../lib/xerces-2.4.0.jar:../lib/xml-parser-apis.jar

TCLASSPATH=$JBOSS_HOME/server/default/lib/xerces-2.4.0.jar:$JBOSS_HOME/server/default/lib/xml-parser-apis.jar
JBOSS_CLASSPATH=$JBOSS_CLASSPATH:$TCLASSPATH

JAXP=-Djavax.xml.parsers.DocumentBuilderFactory=org.apache.xerces.jaxp.DocumentBuilderFactoryImpl
JAXP="$JAXP -Djavax.xml.parsers.SAXParserFactory=org.apache.xerces.jaxp.SAXParserFactoryImpl -Daa=bb"

JAVA_OPTS="-Xms128m -Xmx256m $JAXP $JAVA_OPTS -Dprogram.name=$PROGNAME"
...
if $useprofiler; then
    ...
    do
    # Execute the JVM
       echo "$JAVA $JAVA_OPTS -classpath $JBOSS_CLASSPATH org.jboss.Main $@"
