...
#JAVA_OPTS="-Xms384m -XX:MaxPermSize=256m -XX:ThreadStackSize=512 -XX:GCTimeRatio=99 -XX:+DisableExplicitGC -Dprogram.name=$PROGNAME $JAVA_OPTS"
JAVA_OPTS="-Xms512m -Xmx512m -XX:NewRatio=2 -XX:MaxPermSize=256m -XX:ThreadStackSize=512 -XX:GCTimeRatio=99 -XX:+DisableExplicitGC -Dprogram.name=$PROGNAME $JAVA_OPTS"

# Setup the java endorsed dirs
JBOSS_ENDORSED_DIRS="$JBOSS_HOME/lib/endorsed"

# For the compatibility issue between JBOSS 4.0.5 GA client and JBOSS4.2.2GA server
# JAVA_OPTS="$JAVA_OPTS -Djboss.remoting.pre_2_0_compatible=true"
