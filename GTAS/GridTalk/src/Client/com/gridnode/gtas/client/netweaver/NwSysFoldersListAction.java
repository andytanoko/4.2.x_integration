...
public class NwSysFoldersListAction extends EntityListAction
{
    ...
    throws GTClientException
  {
    ...
    else
    {
      ...
      else
      {
        ...
        return manager.getListPager(folder, IGridDocument.FOLDER, false, sortField, sortAscending); // 20031019 DDJ
      }
    }
  }
  ...
  protected void processPipeline( ActionContext actionContext,
    ...
    throws GTClientException
  {
    rPipe.addRenderer(new NwSysFoldersListDecoratorRenderer(rContext,getFolder(actionContext)));
    //TEST
    RenderingPipelineImpl rpi = (RenderingPipelineImpl) rPipe;
    rpi.setConvertAnchors(false);
  }
