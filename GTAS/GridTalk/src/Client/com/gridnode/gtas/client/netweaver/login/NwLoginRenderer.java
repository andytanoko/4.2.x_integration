...
import com.gridnode.gtas.client.web.login.*;

public class NwLoginRenderer extends AbstractLoginRenderer implements IDocumentRenderer
{

  public NwLoginRenderer( RenderingContext rContext,
                        LoginAForm form,
                        String submitUrl)
  ...
  { //20030107AH - Mod to use RenderingContext
    try
    {
      ...
      renderLabel("login_heading","login.heading.netweaver",false);
