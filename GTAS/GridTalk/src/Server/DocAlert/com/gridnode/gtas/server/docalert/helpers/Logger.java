 ...
 * Feb 26 2003    Neo Sok Lay         Add FacadeLogger for DocAlertRequestMDBean.
...
/**
 * This class handles the logging for the DocAlert module.
 *
 * @author Neo Sok Lay
 *
 * @version GT 4.0 VAN
...
public class Logger
{
  private static final String CATEGORY_MAIN = "GTAS.DOCALERT";
  ...
  private static final String[] REMINDER_FACADE =
  {
    CATEGORY_MAIN + ".REMINDER",
    "ReminderAlertMDBean",
  };

  private static final String[] DOC_ACTIVITY_FACADE =
  {
    CATEGORY_MAIN + ".DOC.SEND",
    "DocumentActivityMDBean",
  };

  private static final String[] ALERT_REQ_FACADE =
  {
    CATEGORY_MAIN + ".ALERT.REQ",
    "AlertRequestMDBean",
  };
  ...
  /**
   * Get the FacadeLogger for the ReminderAlertMDBean.
   */
  public static FacadeLogger getReminderFacadeLogger()
  {
    return FacadeLogger.getLogger(
            REMINDER_FACADE[FACADE_INDEX], REMINDER_FACADE[CATEGORY_INDEX]);
  }

  /**
   * Get the FacadeLogger for the DocumentActivityMDBean.
   */
  public static FacadeLogger getDocSendFacadeLogger()
  {
    return FacadeLogger.getLogger(
            DOC_ACTIVITY_FACADE[FACADE_INDEX], DOC_ACTIVITY_FACADE[CATEGORY_INDEX]);
  }

  /**
   * Get the FacadeLogger for the DocAlertRequestMDBean.
   */
  public static FacadeLogger getAlertRequestFacadeLogger()
  {
    return FacadeLogger.getLogger(
            ALERT_REQ_FACADE[FACADE_INDEX], ALERT_REQ_FACADE[CATEGORY_INDEX]);
  }
