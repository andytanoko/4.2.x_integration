...
/**
 * This Action class handles the retrieving of a list of Rfc.
 *
 * @author Koh Han Sing
 *
 * @version 2.0
 * @since 2.0
 */
public class GetRfcListAction
  extends    AbstractGetEntityListAction
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -4420378119068922247L;
	public static final String CURSOR_PREFIX = "RfcListCursor.";
  public static final String ACTION_NAME = "GetRfcListAction";

  protected Class getExpectedEventClass()
  {
    return GetRfcListEvent.class;
  }
  ...
  {
    return ActionHelper.convertRfcToMapObjects(entityList);
  }
