...
/**
 * This class handles the logging for the Registration module.
 *
 * @author Neo Sok Lay
 *
 * @version 2.0 I5
...
public class Logger
{
  private static final String CATEGORY_MAIN = "GTAS.REGISTRATION";

  private static final String[] REG_FACADE = {
                                               CATEGORY_MAIN + ".REG",
                                               "RegistrationBean",
                                             };
  ...
  /**
   * Get the FacadeLogger for the Registration facade.
   */
  public static FacadeLogger getRegistrationFacadeLogger()
  {
    return FacadeLogger.getLogger(
            REG_FACADE[FACADE_INDEX], REG_FACADE[CATEGORY_INDEX]);
  }
