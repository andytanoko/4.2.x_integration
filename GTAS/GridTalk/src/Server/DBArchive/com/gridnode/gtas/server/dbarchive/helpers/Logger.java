...
{
  private static final String CATEGORY_MAIN = "GTAS.DBARCHIVE";

  private static final String CATEGORY = "GTAS.DBARCHIVE";

  private static final String[] ARCHIVE_FACADE = { CATEGORY + ".FC", "DBArchiveManagerBean", };
 ...
 /**
  ...
  {
    return FacadeLogger.getLogger(ARCHIVE_FACADE[FACADE_INDEX], ARCHIVE_FACADE[CATEGORY_INDEX]);
  }
