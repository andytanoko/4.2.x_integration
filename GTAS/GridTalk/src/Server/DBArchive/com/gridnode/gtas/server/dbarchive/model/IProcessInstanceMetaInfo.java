 ...
 * Oct 7,  2005				 Sumedh Chalermkanjana		Added ASSOC_DOC field
...
public interface IProcessInstanceMetaInfo
{
  ...
  public static final Number Doc_Date_Generated = new Integer(13); //String
  
  public static final Number Originator_ID = new Integer(14); //String
  
  public static final Number ASSOC_DOCS = new Integer(15); //Collection
  
  public static final Number USER_TRACKING_ID = new Integer(16); //String
  
  public static final Number REMARK = new Integer(17); //String
