...
public class DisconnectAction extends AbstractConnectionAction
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -3574208062391377352L;
	private final String ACTION_NAME = "DisconnectAction";
  ...
  protected IEventResponse constructErrorResponse(IEvent event, TypedException ex)
  {
    ...
    return constructEventResponse(
             IErrorCode.DISCONNECTION_ERROR,
             params,
             ex);
  }
  ...
  protected IEventResponse doProcess(IEvent event) throws java.lang.Throwable
  {
    ...
    ServiceLookupHelper.getConnectionService().disconnect();
