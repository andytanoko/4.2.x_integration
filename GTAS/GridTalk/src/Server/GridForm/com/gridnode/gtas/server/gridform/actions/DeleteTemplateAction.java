 ...
 *
 * File: DeleteTemplateAction.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
...
import com.gridnode.gtas.events.gridform.DeleteTemplateEvent;
 ...
 * @author Jared Low
 */
public class DeleteTemplateAction extends GridTalkEJBAction
{
  public IEventResponse perform(IEvent event) throws EventException
  {
    ...
    try
    {
      ...
      DeleteTemplateEvent deleteTemplateEvent = (DeleteTemplateEvent)event;
      if (deleteTemplateEvent == null)
      {
        throw new EventException("Event is null");
      }

      mgr.deleteGFTemplate(deleteTemplateEvent.getUID());
  ...
  private IEventResponse constructEventResponse(NestingException ex)
  {
    ...
    Logger.err("[DeleteTemplateAction.perform] Event Error", ex);
    return response;
  }
