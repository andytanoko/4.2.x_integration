 ...
 * Feb 26 2003    Daniel D'Cotta      Added SubPath for Schema support
 */
...
public interface IMappingFile
{
   ...
   */
  public static final Number FILENAME    = new Integer(5); //String(120)

  /**
   * FieldId for the Path of the MappingFile. A String.
   */
  public static final Number PATH        = new Integer(6); //String(120)
