...
public interface IGridTalkMappingRule
{
   ...
   */
  //public static final Number HEADER_TRANSFORMATION = new Integer(8);  //Boolean
  //20020711AH - Corrected typo in field id number
   ...
   */
  //public static final Number TRANSFORM_WITH_HEADER = new Integer(9);  //Boolean
  //20020711AH - Corrected typo in field id number
   ...
   */
  //public static final Number TRANSFORM_WITH_SOURCE = new Integer(10);  //Boolean
  //20020711AH - Corrected typo in field id number
   ...
   */
  //public static final Number MAPPING_RULE  = new Integer(11); //MappingRule
  //20020711AH - Corrected typo in field id number
