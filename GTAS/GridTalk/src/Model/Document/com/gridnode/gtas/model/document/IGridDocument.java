 ...
 * Nov 06 2006    Regina Zeng         Add fields:
 *                                    - SENDER_CERT
 *                                    - RECEIVER_CERT
 *                                    - DOC_DATE_GEN
 *                                    - ORIGINAL_DOC                                    
...
public interface IGridDocument
{
   ...
   */
  public static final Number R_PARTNER_TYPE = new Integer(28);  //String(3)

  /**
   * FieldId for RecipientPartnerGroup. A String.
   */
  public static final Number R_PARTNER_GROUP = new Integer(29);  //String(3)

  /**
   * FieldId for RecipientBizEntityId. A String.
   */
  public static final Number R_BIZ_ENTITY_ID = new Integer(30);  //String(4)
   ...
   */
  public static final Number S_USER_ID = new Integer(36);  //String(15)

  /**
   * FieldId for SenderUserName. A String.
   */
  public static final Number S_USER_NAME = new Integer(37);  //String(50)

  /**
   * FieldId for SenderBizEntityId. A String.
   */
  public static final Number S_BIZ_ENTITY_ID = new Integer(38);  //String(4)

  /**
   * FieldId for SenderRoute. A String.
   */
  public static final Number S_ROUTE = new Integer(39);  //String(20)
   ...
   */
  public static final Number S_PARTNER_TYPE = new Integer(41);  //String(3)

  /**
   * FieldId for SenderPartnerGroup. A String.
   */
  public static final Number S_PARTNER_GROUP = new Integer(42);  //String(3)
  ...
  /**
   * FieldId for ActivityList. A Vector of
  ...
  /**
   * FieldId for ProcessDefId. A String. Not persistent in DB.
   */
  ...
  /**
   * FieldId for Attachments. A Vector.
   */
