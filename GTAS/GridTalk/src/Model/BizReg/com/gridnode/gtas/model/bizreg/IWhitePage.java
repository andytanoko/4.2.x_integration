 ...
 * Date           Author              Changes
 ****************************************************************************
 * Jul 30 2001    Neo Sok Lay         Created
 */
...
public interface IWhitePage
{
   ...
   */
  public static final Number EMAIL = new Integer(6);  //string(255)
   ...
   */
  public static final Number WEBSITE = new Integer(9);  //string(255)

  /**
   * FieldId for Address. A String.
   */
  public static final Number ADDRESS = new Integer(10); //string(255)
