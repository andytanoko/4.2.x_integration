 ...
 * Dec 23 2003    Neo Sok Lay         Add DOMAIN_IDENTIFIERS field.
 */
...
public interface IBusinessEntity
{
  ...
  /**
   * Active state. The BusinessEntity belongs to a active partner enterprise.
   * Value = 2.
   */
  public static final int STATE_ACTIVE    = 2;

  /**
   * Inactive state. The BusinessEntity belongs to a non-active "partner"
   * enterprise. Value = 4.
   */
  public static final int STATE_INACTIVE  = 3;

  /**
   * Pending state. The BusinessEntity belongs to a pending-active "partner"
   * enterprise. Value = 3.
   */
