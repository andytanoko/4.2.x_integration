 ...
 *
 * File: UpdateMessageTemplateEvent.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
...
/**
 * This Event class contains the data for updating a MessageTemplate.
 *
 ...
 * @since 2.0
 */
public class UpdateMessageTemplateEvent extends EventSupport
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -688812265287644931L;
   ...
   *
   * @param uid UID of the Message Template to update.
   ...
   */
  public UpdateMessageTemplateEvent(
    Long    uid,
    String  messageType,
    String  location,
    Boolean isAppend,
  ...
  public UpdateMessageTemplateEvent(Long uid, String name, String messageType,
  ...
  {
    return "java:comp/env/param/event/UpdateMessageTemplateEvent";
  }
}