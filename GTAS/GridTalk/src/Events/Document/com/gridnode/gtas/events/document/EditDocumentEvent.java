 ...
 * @since 2.0
 */
public class EditDocumentEvent extends EventSupport
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -7906928843460108145L;
	public static final String G_DOC_UID = "GridDocument UID";

  public EditDocumentEvent(Long gDocUID)
  {
  ...
  {
    return "java:comp/env/param/event/EditDocumentEvent";
  }
