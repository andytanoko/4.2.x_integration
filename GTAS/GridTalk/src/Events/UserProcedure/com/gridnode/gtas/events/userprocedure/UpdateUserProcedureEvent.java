 ...
 *
 * File: UpdateUserProcedureEvent.java
 *
 ****************************************************************************
 * Date           Author                  Changes
 ****************************************************************************
 ...
 * Mar 22 2006    Neo Sok Lay             Uncomment GridDocField in constructor
 */
...
/**
 * This event class contains the data for updating the ProcedureDefiniton.
 *
 *
 * @author Jagadeesh.
 *
...
public class UpdateUserProcedureEvent extends EventSupport
{ 
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -8767099617005910484L;
  ...
  public UpdateUserProcedureEvent(
    Long    uID,
    String  name,
    String  description,
  ...
  throws EventException
  {
    ...
    checkSetObject(PROC_DEF,procDef,HashMap.class);
...
//    return ((Integer)getEventData(DEF_ACTION)).intValue();
  ...
  {
    return "java:comp/env/param/event/UpdateUserProcedureEvent";
  }
}
