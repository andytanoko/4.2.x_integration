 ...
 *
 * File: UpdateProcedureDefFileEvent.java
 *
 ****************************************************************************
 * Date           Author                  Changes
 ****************************************************************************
...
/**
 * This event class contains the data for updating the ProcedureDefiniton File.
 *
 *
 * @author Jagadeesh.
 *
...
public class UpdateProcedureDefFileEvent extends EventSupport
{ 

  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 3910864369757417049L;
  ...
  public UpdateProcedureDefFileEvent(
    Long uID,
    String name,
    String description,
    Integer type,
    String filename) throws EventException
  {
    checkSetString(NAME,name);
    checkSetString(DESCRIPTION,description);
    checkSetInteger(TYPE,type);
    setEventData(FILE_NAME,filename);
...
*/
  ...
  {
    return "java:comp/env/param/event/UpdateProcedureDefFileEvent";
  }
}
