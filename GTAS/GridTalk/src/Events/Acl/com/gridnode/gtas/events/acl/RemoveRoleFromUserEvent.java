 ...
 *
 * File: RemoveRoleFromUserEvent.java
 *
 ****************************************************************************
 * Date           Author                  Changes
 ****************************************************************************
...
/**
 * This event class contains the data for deletion of a Role-User relationship.
 *
 *
 * @author Goh Kan Mun
 *
...
public class RemoveRoleFromUserEvent extends EventSupport implements IGuardedEvent
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -8757857703023078355L;
	private static final String GUARDED_FEATURE = "USER.ADMIN";
  private static final String GUARDED_ACTION = "RemoveRoleFromUser";
  ...
  public RemoveRoleFromUserEvent(Long userUId, Long roleUId)
  ...
  public RemoveRoleFromUserEvent(String userId, String roleName)
    throws EventException
  {
  ...
  {
    return "java:comp/env/param/event/RemoveRoleFromUserEvent";
  }
