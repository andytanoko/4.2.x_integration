 ...
 *
 * File: CreateGridTalkMappingRuleEvent.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
 ...
 * @since 2.0
 */
public class CreateGridTalkMappingRuleEvent
  extends EventSupport
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -6682296807600646796L;
	public static final String MAPPING_RULE_NAME      = "MappingRule Name";
  ...
  public CreateGridTalkMappingRuleEvent(
    ...
    String mappingClass)
  {
    setEventData(MAPPING_RULE_NAME, mappingRuleName);
  ...
  public String getGridTalkMappingRuleName()
  {
    return (String)getEventData(MAPPING_RULE_NAME);
  }
  ...
  {
    return "java:comp/env/param/event/CreateGridTalkMappingRuleEvent";
  }
