 ...
 *
 * File: UpdateResponseTrackRecordEvent.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
...
/**
 * This Event class contains the data for updating a ResponseTrackRecord.
 *
 * @author Neo Sok Lay
 *
 * @version 2.1
 * @since 2.0 I7
 */
public class UpdateResponseTrackRecordEvent extends EventSupport
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 8999150506795640088L;
  ...
  public UpdateResponseTrackRecordEvent(
    Long uid,
    String sentDocType,
  ...
  {
    return "java:comp/env/param/event/UpdateResponseTrackRecordEvent";
  }
