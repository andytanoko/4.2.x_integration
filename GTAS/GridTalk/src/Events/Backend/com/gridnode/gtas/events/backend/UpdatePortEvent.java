 ...
 *
 * File: UpdatePortEvent.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
 * Dec 18 2002    Koh Han Sing        Created
 * May 26 2003    Jagadeesh           Added : Fields for Port Enhancement.
 * Aug 26 2005    Tam Wei Xiang       Field 'ATTACHMENT_DIR' has been removed.
...
/**
 * This Event class contains the data for the updating of a Port.
 *
 * @author Koh Han Sing
 *
 * @version 2.0
 * @since 2.0
 */
public class UpdatePortEvent
  extends EventSupport
{
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -1745536772860308922L;
  ...
  public static final String FIX_NUM_LENGTH    = "Fixed Number Length";
  public static final String FILE_GROUPING      = "File Grouping";

  public UpdatePortEvent(Long portUid,
                         String description,
                         Boolean isRfc,
                         Long rfc,
                         String hostDir,
                         ...
                         Integer fileGrouping)
  {
    ...
    setEventData(FIX_NUM_LENGTH,fixedNum);
  ...
  {
    return (Integer)getEventData(FIX_NUM_LENGTH);
  }
  ...
  {
    return "java:comp/env/param/event/UpdatePortEvent";
  }
