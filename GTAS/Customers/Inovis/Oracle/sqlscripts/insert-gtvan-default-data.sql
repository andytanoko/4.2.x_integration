-- 26 June 2007    [Tam Wei Xiang]      GTVAN      i)  Added in template for generic archive alert, modified
--                                                 existing archive template to add in archive ID.
--                                                 ii) Added in archiveSummLock
--                                                 iii)Set config_props "ISAT", "audit.archive.total.process.in.zip" to 100
--                                                 iv) Added in HA JNDI lookup props, singleton mbean
--                                                 v)  New scheduler record for keep track archive task status
...
-- #1105 For HTTPBC processBackTxQueue JMS properties
...
-- #1105 For HTTPBC Tx Delivery Info Props
...
-- #1105 For HTTP BC global locking
...
---
INSERT INTO "adm_users" VALUES ('ADMIN','ADMIN','','admin','9v3/5IyQjesPTDvTbAMucg==','admin',TO_TIMESTAMP(SYSDATE,'YYYY-MM-DD HH24:MI:SS.FF3'),'Web Admin','GridNode',NULL,NULL,NULL,'offline','Yes',1);
...
-- default groups
INSERT INTO "adm_groups" VALUES ('GridNode',1,'GND');
INSERT INTO "adm_groups" VALUES ('Inovis',2,'DEF');

INSERT INTO "isat_biz_entity_group_mapping" ("uid","be_id","group_name") VALUES ('1','GND','GridNode');
INSERT INTO "isat_biz_entity_group_mapping" ("uid","be_id","group_name") VALUES ('2','DEF','Inovis');
