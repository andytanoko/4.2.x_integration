...
/**
 * NOTE: The 4C1 post processor is quite similiar to 4A5 post process. Although the processing look
 * simliar, for the ease of changes in near future we won't have much constraint on the need to consider
 * the 4A5 post processing in mind.
 * 
 * @author Tam Wei Xiang
 * @version GT 4.1.3
 */
public class XML4C1Processor
{
  private static final String CUSTOMER_ITEM_HEADER = "#Customer Item";
  private static final String SUPPLIER_HEADER = "Supplier";
  private static final String CUSTOMER_SITE_HEADER = "Customer Site";
  ...
  private static final String DATA_MEASURE = "SLC On-Hand";
  
  public static void main(String[] args) throws Exception
  {
    String filepath = "D:/wxtam/My Task/2009/Inovis/Intel_Dell_Project_1_March/4C1/MidFile_UnPackage5932659330.txt";
    XML4C1Processor processor = new XML4C1Processor();
    processor.postProcess4C1Flat(filepath, "\t");
  }
  
  public XML4C1Processor()
  {
    
  }
  
  public void postProcess4C1Flat(String filepath, String delim) throws Exception
  {
