...
IF "%SEARCH_DIR%"=="" (
  SET SEARCH_DIR=C:\GridNode\GridTalk\jboss-3.0.5_tomcat-4.0.6\bin\gtas\data\alert\log\docStatus
)
...
if "%FEEDBACK_BAT%"=="" (
  SET FEEDBACK_BAT="C:\GridNode\GridApp\receiver\gridappimport.bat"
)
