...
public class myXML implements Serializable {
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -7416383141279123806L;
...
// -----------------------------------------------------------------------------
  ...
  public class Attribute {
    ...
    protected String dumpattributes() {
      int i;
...
// are used in the application or entered by the user.
  protected Object cleanup(Object o)
  {
...
// object.
  private class myFileReader implements Serializable {
    /**
		 * Serial Version UID
		 */
		private static final long serialVersionUID = 4879501536927543477L;
...
//------------------------------------------------------------------------------
  ...
  static public class myXMLEncodingException extends Exception implements Serializable {
    /**Serial Version UID
		 * 
		 */
		private static final long serialVersionUID = -8170256174351456169L;
  ...
  static public class myXMLException extends Exception implements Serializable {
    /**
		 * Serial Version UID
		 */
		private static final long serialVersionUID = -99137208857602065L;
  ...
  static public class myXMLIOException extends Exception implements Serializable {
    /**
		 * Serial Version UID
		 */
		private static final long serialVersionUID = 4700407322081104997L;
