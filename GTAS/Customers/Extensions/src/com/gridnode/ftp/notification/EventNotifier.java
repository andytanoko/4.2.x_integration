...
public class EventNotifier
{
  ...
  private static final String FEED_BACK_TXMR_EVENT = "is.feedback.txmr.event";
  ...
  public void notifyDocumentToBackendFailed(String tracingID,String messageID, int ftpResponseCode, String errorMessage) 
  {
    ...
    {
    	Properties jmsProps = getJMSProps();
      if(isFeedbackTXMREvent(jmsProps))
      {
      	String eventName = getDocDeliveredToBackendEvent(jmsProps);
  ...
  private boolean isFeedbackTXMREvent(Properties jmsProps)
  {
    String isFeedbackEvent = jmsProps.getProperty(FEED_BACK_TXMR_EVENT, "true");
    return Boolean.valueOf(isFeedbackEvent);
  }
