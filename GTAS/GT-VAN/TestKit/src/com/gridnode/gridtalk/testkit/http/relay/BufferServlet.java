...
public class BufferServlet extends HttpServlet
{
   ...
   * 
   */
  private static final long serialVersionUID = 1457657698456L;

  File dataFolder = new File(HttpBackendRelay.DATA_FOLDER);

  private static int counter = 0;

  HttpBackendRelay backendRelay = new HttpBackendRelay();
