// %1023788045981:com.gridnode.pdip.base.time.ejb%
/**
...
public interface IiCalDateHome
  extends EJBHome
{
   ...
   */
  public IiCalDateObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalDateObj findByPrimaryKey(Long primaryKey)
