// %1023788046059:com.gridnode.pdip.base.time.ejb%
/**
...
public interface IiCalEventHome
  extends EJBHome
{
   ...
   */
  public IiCalEventObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalEventObj findByPrimaryKey(Long primaryKey)
