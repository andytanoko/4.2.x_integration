// %1023788046356:com.gridnode.pdip.base.time.ejb%
/**
...
public interface IiCalPropertyHome
  extends EJBHome
{
   ...
   */
  public IiCalPropertyObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalPropertyObj findByPrimaryKey(Long primaryKey)
