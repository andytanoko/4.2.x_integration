// %1023788047199:com.gridnode.pdip.base.time.ejb%
/**
...
public interface IiCalTodoHome
  extends EJBHome
{
   ...
   */
  public IiCalTodoObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalTodoObj findByPrimaryKey(Long primaryKey)
