// %1023788046215:com.gridnode.pdip.base.time.ejb%
/**
  ...
  extends EJBHome
{
   ...
   */
  public IiCalIntObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalIntObj findByPrimaryKey(Long primaryKey)
