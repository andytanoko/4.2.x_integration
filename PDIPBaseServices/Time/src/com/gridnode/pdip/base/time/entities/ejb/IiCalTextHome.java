// %1023788046840:com.gridnode.pdip.base.time.ejb%
/**
...
public interface IiCalTextHome
  extends EJBHome
{
   ...
   */
  public IiCalTextObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IiCalTextObj findByPrimaryKey(Long primaryKey)
