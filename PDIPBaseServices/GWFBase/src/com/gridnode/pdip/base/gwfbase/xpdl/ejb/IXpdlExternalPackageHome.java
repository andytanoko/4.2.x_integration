// %1023949933843:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlExternalPackageHome
  extends EJBHome
{
   ...
   */
  public IXpdlExternalPackageObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlExternalPackageObj findByPrimaryKey(Long primaryKey)
