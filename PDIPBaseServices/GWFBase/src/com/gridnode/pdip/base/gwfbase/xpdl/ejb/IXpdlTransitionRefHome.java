// %1023949934374:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlTransitionRefHome
  extends EJBHome
{
   ...
   */
  public IXpdlTransitionRefObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlTransitionRefObj findByPrimaryKey(Long primaryKey)
