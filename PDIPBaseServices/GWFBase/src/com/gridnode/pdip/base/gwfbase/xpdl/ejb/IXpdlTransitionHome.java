// %1023949934311:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlTransitionHome
  extends EJBHome
{
   ...
   */
  public IXpdlTransitionObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlTransitionObj findByPrimaryKey(Long primaryKey)
