// %1023949933374:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlActivityHome
  extends EJBHome
{
   ...
   */
  public IXpdlActivityObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlActivityObj findByPrimaryKey(Long primaryKey)
