// %1023949931280:com.gridnode.pdip.base.gwfbase.bpss.ejb%
/**
...
public interface IBpssStartHome
  extends EJBHome
{
   ...
   */
  public IBpssStartObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IBpssStartObj findByPrimaryKey(Long primaryKey)
