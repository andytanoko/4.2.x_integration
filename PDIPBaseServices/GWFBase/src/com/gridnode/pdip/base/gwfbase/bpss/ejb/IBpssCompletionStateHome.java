// %1023949930952:com.gridnode.pdip.base.gwfbase.bpss.ejb%
/**
...
public interface IBpssCompletionStateHome
  extends EJBHome
{
   ...
   */
  public IBpssCompletionStateObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IBpssCompletionStateObj findByPrimaryKey(Long primaryKey)
