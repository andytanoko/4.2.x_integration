// %1023949934468:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlTypeDeclarationHome
  extends EJBHome
{
   ...
   */
  public IXpdlTypeDeclarationObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlTypeDeclarationObj findByPrimaryKey(Long primaryKey)
