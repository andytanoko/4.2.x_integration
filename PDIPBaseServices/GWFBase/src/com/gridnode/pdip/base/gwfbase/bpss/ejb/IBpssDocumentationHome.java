...
public interface IBpssDocumentationHome  extends EJBHome {

	public IBpssDocumentationObj create(IEntity data) throws CreateException,RemoteException;
	public IBpssDocumentationObj findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
