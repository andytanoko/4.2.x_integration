// %1023949930983:com.gridnode.pdip.base.gwfbase.bpss.ejb%
/**
...
public interface IBpssForkHome
  extends EJBHome
{
   ...
   */
  public IBpssForkObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IBpssForkObj findByPrimaryKey(Long primaryKey)
