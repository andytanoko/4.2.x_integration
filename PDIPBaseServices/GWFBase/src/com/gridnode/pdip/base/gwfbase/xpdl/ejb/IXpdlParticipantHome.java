// %1023949934014:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlParticipantHome
  extends EJBHome
{
   ...
   */
  public IXpdlParticipantObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlParticipantObj findByPrimaryKey(Long primaryKey)
