...
public interface IBpssMultiPartyCollaboration
{

    public static final String ENTITY_NAME = "BpssMultiPartyCollaboration";
    ...
    public static final Number MAX_CONCURRENCY = new Integer(3);
}
