// %1023949930858:com.gridnode.pdip.base.gwfbase.bpss.ejb%
/**
...
public interface IBpssBusinessTransHome
  extends EJBHome
{
   ...
   */
  public IBpssBusinessTransObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IBpssBusinessTransObj findByPrimaryKey(Long primaryKey)
