// %1023949933905:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlComplexDataTypeHome
  extends EJBHome
{
   ...
   */
  public IXpdlComplexDataTypeObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlComplexDataTypeObj findByPrimaryKey(Long primaryKey)
