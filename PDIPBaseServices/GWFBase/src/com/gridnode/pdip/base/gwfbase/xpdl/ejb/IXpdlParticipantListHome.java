// %1023949934030:com.gridnode.pdip.base.gwfbase.xpdl.ejb%
/**
...
public interface IXpdlParticipantListHome
  extends EJBHome
{
   ...
   */
  public IXpdlParticipantListObj create(IEntity data)
   ...
   * @throws RemoteException DOCUMENT ME!
   */
  public IXpdlParticipantListObj findByPrimaryKey(Long primaryKey)
