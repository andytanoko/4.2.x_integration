...
public class ComparisonCondition extends TagSupport
{
  ...
  public int doStartTag() throws JspTagException
  {
    try{
      ...
      String query = _searchObj.addComparisonConditionToQuery(connector,field,compOperator,value,isFieldValue,negate);
      queryHandler.setQuery(query);
      System.out.println(" In doStartTag == ComparisonCondition.java" + query);
  ...
  public void lookUpSearchManagerBean() throws SystemException
  {
	...
	_searchHome = (ISearchManagerHome)ServiceLookup.getInstance(
      ...
      {
	Logger.err(" Exception in ComparisonCondition.lookUpSearchManagerBean() : ", ex);
