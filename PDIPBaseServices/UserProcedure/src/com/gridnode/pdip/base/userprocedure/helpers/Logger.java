...
/**
 * This class handles the logging for the User Procedure module.
 *
 * @author Jagadeesh
 *
 * @version GT 4.0 VAN
...
public class Logger
{
  ...
  private static final String CATEGORY = "BASE.USERPROCEDURE";
   ...
   * @see com.gridnode.pdip.base.userprocedure.exceptions.ILogErrorCodes
   * 
   * @param errorCode
   * @param msg
   */
