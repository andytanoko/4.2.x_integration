 ...
 * 07 Jun 2002    Jagadeesh           Changed to throw CertificateException
 *                                    and Log for GridTalk-2.0.
 * 15 Jun 2009      Tam Wei Xiang     #560: Migrate from RSA J-SAFE/B-SAFE to BouncyCastle Lib
 */
...
public class CertVerifier
{
  ...
  private java.security.cert.X509Certificate _subjectCert, _issuerCert;
   ...
   *
   */
  public CertVerifier(byte[] subjectCertData) throws CertificateException
  {
...
//    throws GNException
   ...
   *
   */
  public int isIssuedBy(X509Certificate issuerCert) throws CertificateException
  {
   ...
   *
   */
  public int isIssuedBy(byte[] issuerCertData) throws CertificateException
  {
   ...
   *
   */
  public int isIssuedBy() throws CertificateException
  {
    if(_subjectCert == null)
      throw new CertificateException("Subject certificate is not set !!!");
    if(_issuerCert == null)
   ...
   *
   */
  private boolean verifySignature() throws CertificateException
  {
    ...
    {
      throw new CertificateException("Unable to retrieve public key from certificate");
    }
    try
    {
    ...
    {
      throw new CertificateException("Unable to perform the signature algorithm", ex);
    }
    /*
    if(!b)
      errorCode = ERR_SIGNATURE_ERROR;
      */
  }
   ...
   *
   */
  private static X509Certificate getCert(byte[] certData) throws CertificateException
  {
    X509Certificate certificate = null;
    try
    {
      certificate = GridCertUtilities.loadCertificateFromByte(certData);
    }
    catch (Exception ex)
    {
      throw new CertificateException("Data passed in is not a valid X.509 certificate");
    }
   ...
   *
   */
  public void setSubjectCert(byte[] subjectCertData) throws CertificateException
  {
   ...
   *
   */
  public void setIssuerCert(byte[] issuerCertData) throws CertificateException
  {
