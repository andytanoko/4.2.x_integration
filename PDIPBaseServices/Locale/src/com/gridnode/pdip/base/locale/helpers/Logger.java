...
{
  private static final String CATEGORY_MAIN = "BASE.LOCALE";

  private static final String[] COUNTRY_FACADE =  {
                                                    CATEGORY_MAIN + ".CTY",
                                                    "LocaleManagerBean",
                                                  };

  private static final String[] LANGUAGE_FACADE = {
                                                    CATEGORY_MAIN + ".LANG",
                                                    "LocaleManagerBean",
                                                  };
  ...
  /**
   * Get the FacadeLogger for the Country facade.
   */
  public static FacadeLogger getCountryFacadeLogger()
  {
    return FacadeLogger.getLogger(
            COUNTRY_FACADE[FACADE_INDEX], COUNTRY_FACADE[CATEGORY_INDEX]);
  }

  /**
   * Get the FacadeLogger for the Language facade
   */
  public static FacadeLogger getLanguageFacadeLogger()
  {
    return FacadeLogger.getLogger(
            LANGUAGE_FACADE[FACADE_INDEX], LANGUAGE_FACADE[CATEGORY_INDEX]);
  }
   ...
   * @see com.gridnode.pdip.base.locale.exceptions.ILogErrorCodes
   * 
   * @param errorCode
   * @param msg
   */
