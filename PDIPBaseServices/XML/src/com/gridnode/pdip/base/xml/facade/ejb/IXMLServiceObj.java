 ...
 *                                    - The business method transform does not throw java.rmi.RemoteException
 *                                    - The business method convert does not throw java.rmi.RemoteException
 *                                    - The business method validate does not throw java.rmi.RemoteException
 *                                    - The business method getRoot does not throw java.rmi.RemoteException
 *                                    - The business method newDocument does not throw java.rmi.RemoteException
 *                                    - The business method getDocument does not throw java.rmi.RemoteException
 *                                    - The business method newElement does not throw java.rmi.RemoteException
 *                                    - The business method writeToFile does not throw java.rmi.RemoteException
 *                                    - The business method splitXML does not throw java.rmi.RemoteException
 *                                    - The business method validateDTD does not throw java.rmi.RemoteException
 *                                    - The business method appendXML does not throw java.rmi.RemoteException
 *                                    - The business method getXPathValues does not throw java.rmi.RemoteException
 *                                    - The business method validateSchema does not throw java.rmi.RemoteException
 *                                    - The business method getRootName does not throw java.rmi.RemoteException
 *                                    - The business method extractDTDFilename does not throw java.rmi.RemoteException
 *                                    - The business method newDocumentType does not throw java.rmi.RemoteException
 *                                    - The business method newNamespace does not throw java.rmi.RemoteException
 */
...
public interface IXMLServiceObj extends EJBObject
{
...
//                      throws XMLException;
  ...
  public File convert(String input, String rules)
                      throws XMLException, RemoteException;
