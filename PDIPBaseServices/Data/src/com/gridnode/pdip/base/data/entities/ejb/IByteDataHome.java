...
public interface IByteDataHome  extends EJBHome {

	public IByteDataObject create(IEntity data) throws CreateException,RemoteException;
	public IByteDataObject findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
