...
public interface IDataItemHome  extends EJBHome {

	public IDataItemObject create(IEntity data) throws CreateException,RemoteException;
	public IDataItemObject findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
