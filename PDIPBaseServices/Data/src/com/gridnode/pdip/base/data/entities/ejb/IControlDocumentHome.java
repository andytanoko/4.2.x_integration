...
public interface IControlDocumentHome  extends EJBHome {

	public IControlDocumentObject create(IEntity data) throws CreateException,RemoteException;
	public IControlDocumentObject findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
