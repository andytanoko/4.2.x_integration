...
public interface IStringDataHome  extends EJBHome {
	...
	public IStringDataObj create(IEntity data) throws CreateException,RemoteException;
	public IStringDataObj findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
