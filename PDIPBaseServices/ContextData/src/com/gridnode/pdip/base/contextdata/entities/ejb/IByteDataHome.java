...
public interface IByteDataHome  extends EJBHome {
	...
	public IByteDataObj create(IEntity data) throws CreateException,RemoteException;
	public IByteDataObj findByPrimaryKey(Long primaryKey) throws FinderException,RemoteException;
