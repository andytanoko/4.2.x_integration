 ...
 *
 * File: ITransportControllerObj.java
 *
 ****************************************************************************
 * Date           Author                  Changes
 ****************************************************************************
 ...
 *
 * ITransportControllerHome home = (ITransportControllerHome)PortableRemoteObject.narrow(ObjectRef,ITransportControllerHome.class);
 *
 * ITransportControllerObj l_transportFacade = home.create();
 *
 * l_transportFacade.send(.....);
 */

public interface ITransportControllerObj extends EJBObject
{
