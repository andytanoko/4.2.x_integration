 ...
 *                                                       file will not occur.
 * Jul 28 2003    Jagadeesh                   Modified - Moved from Base.packaging to App.Channel
 *
 * Aug 08 2003    Jagadeesh                   Modified - Channel Name to be stored as a part of
 *
 *
 */
...
public class FileDescriptor
{
   ...
   */
  private FileDescriptor(File[] files, String fileId, String channelName)
    throws FileAccessException, ApplicationException
  {
    ...
    if (FileHelper
      .exist(IPackagingConstants.PACKAGING_PATH, _subPath, FILE_DESC_FILENAME))
   ...
   * @exception       ApplicationException thrown when an error occurs.
   */
  private FileDescriptor(String fileId)
    throws FileAccessException, ApplicationException
  {
    if (fileId == null)
      throw new ApplicationException("FileId cannot be null!");
  ...
  private synchronized void storeFileDescIntoFile() throws FileAccessException
  {
    ...
    catch (IOException ioe)
    {
      throw new FileAccessException(
        "Unable to store File Descriptor to file.",
        ioe);
    }
    finally
    {
  ...
  private synchronized void getFilesDescFromFile() throws FileAccessException
  {
    ...
    {
      throw new FileAccessException(
        "Unable to get File Descriptor from file.",
        ioe);
    }
    finally
    {
  ...
  /**
   * To retrieve the ChannelName used to send.
   *
   * @return    channelName used to send.
   */
  ...
  public static synchronized FileDescriptor retrieve(
    File[] files,
    String fileId,
    String channelName)
    throws FileAccessException, ApplicationException
  {
    return new FileDescriptor(files, fileId, channelName);
  }
  ...
  public static synchronized FileDescriptor retrieve(String fileId)
    throws FileAccessException, ApplicationException
  {
