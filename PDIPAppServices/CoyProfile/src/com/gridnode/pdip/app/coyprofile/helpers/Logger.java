...
/**
 * This class handles the logging for the CoyProfile module.
 *
 * @author Neo Sok Lay
 *
 * @version GT 4.0 VAN
...
public class Logger
{
  private static final String CATEGORY_MAIN = "APP.COY";

  private static final String[] PROFILE_FACADE =  {
                                                    CATEGORY_MAIN + ".PROFILE",
                                                    "CoyProfileManagerBean",
                                                  };
  ...
  /**
   * Get the FacadeLogger for the CoyProfile facade.
   */
   ...
   * @see com.gridnode.pdip.app.corprofile.exceptions.ILogErrorCodes
   * 
   * @param errorCode
   * @param msg
   */
