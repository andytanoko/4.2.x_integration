// %1023962282473:com.gridnode.pdip.app.deployment.bpss%
/**
...
/**
 * The Success class represents the element "Success" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT Success (ConditionExpression?,Documentation*)&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 5758852246820908669L;

	public Long _uId=null;

  /** xml tag name of this element. */
  public static String _tagName = "Success";
  ...
  /**
     * Creates an empty Success object
     */
  public Success()
  {
    super();
             ...
             throws GWFException
  {
    ...
    BpssCompletionState bpssSuccess = new BpssCompletionState();

    if(this.getConditionExpression()!=null){
        bpssSuccess.setConditionExpression(this.getConditionExpression().getExpression());
        bpssSuccess.setExpressionLanguage(this.getConditionExpression().getExpressionLanguage());
    }
    ...
    if (this.getFromBusinessState() != null)
    {
      ...
      bpssSuccess.setFromBusinessStateKey(KeyConverter.getKey(null,
                                                              this.getFromBusinessState(),
                                                              null));
      //      incomplete.put(this, bpssSuccess);
      bpssSuccess.setConditionGuard(this.getConditionGuard());
      bpssSuccess.setCompletionType(IBpssCompletionState.SUCCESS_TYPE);
    }
    try
    {
      AbstractEntityHandler handler = EntityHandlerFactory.getHandlerFor(
                                          ...
                                          true);
      bpssSuccess = (BpssCompletionState)handler.createEntity(bpssSuccess);
      _uId=(Long)bpssSuccess.getKey();
      incomplete.put(this, bpssSuccess);
      ...
      bpssProcSpecEntry.setEntryType(bpssSuccess.getEntityName());
      bpssProcSpecEntry.setEntryUId(bpssSuccess.getUId());
    ...
    catch (Throwable th)
    {
      ...
      System.out.println("Unable to deploy " + bpssSuccess.getEntityName());
      th.printStackTrace();
  ...
  /**
   * Unmarshals the specified "Success" element back to a Success object.
   */
  public Success buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;
