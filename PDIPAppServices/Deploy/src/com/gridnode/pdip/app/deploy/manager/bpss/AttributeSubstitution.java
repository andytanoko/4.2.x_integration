// %1023962278410:com.gridnode.pdip.app.deployment.bpss%
/**
...
/**
 * The AttributeSubstitution class represents the element "AttributeSubstitution" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT AttributeSubstitution (Documentation)*&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -3119088371068967767L;

	/** xml tag name of this element. */
  public static String _tagName = "AttributeSubstitution";

  //TWX
  /** Defines a attributeName attribute */
  public GNAttribute _attributeName = GNXMLDocumentUtility.newAttribute("attributeName", ""); 
  
  /** Defines a value attribute */
  public GNAttribute _value = GNXMLDocumentUtility.newAttribute("value", "");
  ...
  /**
     * Creates an empty AttributeSubstitution object
     */
  public AttributeSubstitution()
  {
    super();
  }

  /**
     * Gets the value of "attributeName" attribute.
     */
  public String getAttributeName()
  {
    return _attributeName.getValue();
  }
  ...
  /**
     ...
     */
  public void setAttributeName(String value_)
  {
    _attributeName.setValue(value_);
  }
  ...
  /**
   * TWX: Unmarshals the specified "AttributeSubstitution" element back to a AttributeSubstitution object.
   * @param elem
   * @return
   */
  public AttributeSubstitution buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;
  
    
      /** Unmarshals "attributeName" attribute */
  		super.setAttributeValue(_attributeName, elem.getAttribute("attributeName"));
    
      /** Unmarshals "value" attribute */
  		super.setAttributeValue(_value, elem.getAttribute("value"));
  ...
  public GNElement buildElement()
  {
    ...
    /** Marshals "attributeName" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, _attributeName);

    /** Marshals "value" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, _value);
