// %1023962282660:com.gridnode.pdip.app.deployment.bpss%
/**
 ...
 * Oct 17 2005    Neo Sok Lay         For J2EE1.5 compliance: reflection invocation
...
/**
 * The Transition class represents the element "Transition" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT Transition (ConditionExpression?,Documentation*)&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 4128560546374296115L;

	/** xml tag name of this element. */
  public static String _tagName = "Transition";
  ...
  /** Defines a onInitiation attribute */
  public GNAttribute onInitiation = GNXMLDocumentUtility.newAttribute("onInitiation", "");
  ...
  /**
     * Creates an empty Transition object
     */
  public Transition()
  {
    super();
  ...
  /**
     * Gets the value of "onInitiation" attribute.
     */
  public String getOnInitiation()
  {
    return onInitiation.getValue();
  }
  ...
  /**
     ...
     * @param value    New value.
     */
  public void setOnInitiation(String value_)
  {
    onInitiation.setValue(value_);
  }
             ...
             throws GWFException
  {
    ...
    if (this.getConditionExpression() != null)
      finalResult = Utilities.combineResult(GWF_SUCCESS_DIV,
                                            this.getConditionExpression().deploy(
                                                specUId, incomplete));

    //Deploy attributes to database
    BpssTransition bpssTrans = new BpssTransition();
    bpssTrans.setOnInitiation(new Boolean(
                                  this.getOnInitiation().equals("true")
                                  ? true : false));
    boolean isIncomplete = false;
    if (this.getFromBusinessState() != null)
    {
      bpssTrans.setFromBusinessStateKey(KeyConverter.getKey(null,
    ...
    {
      bpssTrans.setToBusinessStateKey(KeyConverter.getKey(null,
    ...
    /*
        if (isIncomplete)
          incomplete.put(this, bpssTrans);
    */
    bpssTrans.setConditionGuard(this.getConditionGuard());
    ...
    try
    {
      ...
      bpssTrans = (BpssTransition)handler.createEntity(bpssTrans);
      if (isIncomplete)
        incomplete.put(this, bpssTrans);
      ...
      parentName = (String)parent.getClass().getMethod("getName", (Class[])null).invoke(
                       parent, (Object[])null);
      Transition[] siblings = (Transition[])parent.getClass().getMethod(
                                                "getTransition", (Class[])null).invoke(
                                    parent, (Object[])null);
      int i = 0;
      while (!siblings[i].getFromBusinessState().equals(this.getFromBusinessState()) ||
             !siblings[i].getToBusinessState().equals(this.getToBusinessState()))
      {
        i++;
      }
      ...
      bpssProcSpecEntry.setEntryType(bpssTrans.getEntityName());
      bpssProcSpecEntry.setEntryUId(bpssTrans.getUId());
    ...
    catch (Throwable th)
    {
      ...
      System.out.println("Unable to deploy " + bpssTrans.getEntityName());
      th.printStackTrace();
                         ...
                         throws GWFException
  {
    ...
    try
    {
      ...
      Utilities.setParentEntryUId(specUId, parentEntryUId,
                                  ...
                                  "::" + pos, BpssTransition.ENTITY_NAME);
    }
    catch (Exception ex)
    {
      ex.printStackTrace();
  ...
  /**
   * Unmarshals the specified "Transition" element back to a Transition object.
   */
  public Transition buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;
      ...
      /** Unmarshals "onInitiation" attribute */
  	  super.setAttributeValue(onInitiation, elem.getAttribute("onInitiation"));
    ...
    ConditionExpression condExpress = new ConditionExpression();
    setConditionExpression(condExpress.buildModel(elem.getChild(
  ...
  public GNElement buildElement()
  {
    ...
    /** Marshals "toBusinessState" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, toBusinessState);

    /** Marshals "fromBusinessStateIDRef" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, fromBusinessStateIDRef);

    /** Marshals "onInitiation" attribute */
  	addAttributeToElement(elem, "", onInitiation);

    /** Marshals "fromBusinessState" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, fromBusinessState);
