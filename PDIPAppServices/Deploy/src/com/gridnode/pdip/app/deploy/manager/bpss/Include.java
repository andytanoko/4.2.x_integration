// %1023962280660:com.gridnode.pdip.app.deployment.bpss%
/**
...
/**
 * The Include class represents the element "Include" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT Include (Documentation)*&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 2301900030816694986L;

	/** xml tag name of this element. */
  public static String _tagName = "Include";
  ...
  public GNAttribute uri = GNXMLDocumentUtility.newAttribute("uri","");
  ...
  /**
     * Creates an empty Include object
     */
  public Include()
  {
    super();
  ...
  /**
   * TWX: Unmarshals the specified "Include" element back to a Include object.
   */
  public Include buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;
      ...
      /** Unmarshals "version" attribute */
  	  super.setAttributeValue(version, elem.getAttribute("version"));

      /** Unmarshals "name" attribute */
  	  super.setAttributeValue(name, elem.getAttribute("name"));

      /** Unmarshals "uuid" attribute */
  	  super.setAttributeValue(uuid, elem.getAttribute("uuid"));

      /** Unmarshals "uri" attribute */
  	  super.setAttributeValue(uri, elem.getAttribute("uri"));
  ...
  public GNElement buildElement()
  {
    ...
    /** Marshals "uri" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_REQUIRED, uri);
