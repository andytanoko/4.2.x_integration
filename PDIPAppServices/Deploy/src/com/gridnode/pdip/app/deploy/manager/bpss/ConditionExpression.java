// %1023962279988:com.gridnode.pdip.app.deployment.bpss%
/**
...
/**
 * The ConditionExpression class represents the element "ConditionExpression" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT ConditionExpression (Documentation)*&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 3262714771461778076L;

	/** xml tag name of this element. */
  public static String _tagName = "ConditionExpression";

  
  /** Defines a expression attribute */
  public GNAttribute expression = GNXMLDocumentUtility.newAttribute("expression", "");
  
  /** Defines a expressionLanguage attribute */
  public GNAttribute expressionLanguage = GNXMLDocumentUtility.newAttribute("expressionLanguage", "");
  ...
  /**
     * Creates an empty ConditionExpression object
     */
  ...
  /**
     * Gets the value of "expression" attribute.
     */
  ...
  /**
     ...
     */
  public void setExpression(String value_)
  {
    expression.setValue(value_);
  }

  /**
     * Gets the value of "expressionLanguage" attribute.
     */
  ...
  /**
     ...
     * @param value    New value.
     */
  public void setExpressionLanguage(String value_)
  {
    expressionLanguage.setValue(value_);
  }
             ...
             throws GWFException
  {
    ...
    /*    java.util.Vector all = new java.util.Vector(8);
        ...
        int finalResult = Utilities.combineResult(this.GWF_SUCCESS_DIV, list.deploy(specUId, incomplete));
    
        //Deploy attributes to database
        BpssConditionExpression bpssCondExp = new BpssConditionExpression();
        bpssCondExp.setExpressionLanguage(this.getExpressionLanguage());
        bpssCondExp.setExpression(this.getExpression());
    
        try {
          AbstractEntityHandler handler=EntityHandlerFactory.getHandlerFor(
            BpssConditionExpression.class.getName(),true);
          bpssCondExp=(BpssConditionExpression)handler.createEntity(bpssCondExp);
    
          BpssProcessSpecEntry bpssProcSpecEntry = new BpssProcessSpecEntry();
          bpssProcSpecEntry.setSpecUId(specUId);
          bpssProcSpecEntry.setEntryName(bpssCondExp.getConditionExpressionName());
          bpssProcSpecEntry.setEntryType(bpssCondExp.getEntityName());
          bpssProcSpecEntry.setEntryUId(bpssCondExp.getUId());
          handler=EntityHandlerFactory.getHandlerFor(
            BpssProcessSpecEntry.class.getName(),true);
          handler.create(bpssProcSpecEntry);
        }
        catch (Exception e) {
          //TODO handle RemoteException, ParseException
          System.out.println("Unable to deploy " + bpssCondExp.getEntityName());
          e.printStackTrace();
  ...
  /**
   * Unmarshals the specified "ConditionExpression" element back to a ConditionExpression object.
   */
  public ConditionExpression buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;

      /** Unmarshals "expression" attribute */
  		super.setAttributeValue(expression, elem.getAttribute("expression"));
      

      /** Unmarshals "expressionLanguage" attribute */
  		super.setAttributeValue(expressionLanguage, elem.getAttribute("expressionLanguage"));
  ...
  public GNElement buildElement()
  {
    ...
    /** Marshals "expression" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, expression);

    /** Marshals "expressionLanguage" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, expressionLanguage);
