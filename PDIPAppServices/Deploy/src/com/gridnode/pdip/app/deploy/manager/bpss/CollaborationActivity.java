// %1023962279723:com.gridnode.pdip.app.deployment.bpss%
/**
...
/**
 * The CollaborationActivity class represents the element "CollaborationActivity" with the content
 * model defined as follows:
 * <p>
 * &lt;!ELEMENT CollaborationActivity (Documentation)*&gt;<br>
 */
  ...
  implements IGWFDeployable
{
  ...
  /**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -950579937715610090L;

	/** xml tag name of this element. */
  public static String _tagName = "CollaborationActivity";
  ...
  /** Defines a binaryCollaborationIDRef attribute */
  public GNAttribute binaryCollaborationIDRef = GNXMLDocumentUtility.newAttribute("binaryCollaborationIDRef", "");
  ...
  /** Defines a binaryCollaboration attribute */
  public GNAttribute binaryCollaboration = GNXMLDocumentUtility.newAttribute("binaryCollaboration", "");
  ...
  /**
     * Creates an empty CollaborationActivity object
     */
  ...
  /**
     * Gets the value of "binaryCollaborationIDRef" attribute.
     */
  public String getBinaryCollaborationIDRef()
  {
    return binaryCollaborationIDRef.getValue();
  }
  ...
  /**
     ...
     * @param value    New value.
     */
  public void setBinaryCollaborationIDRef(String value_)
  {
    binaryCollaborationIDRef.setValue(value_);
  }
  ...
  /**
     * Gets the value of "binaryCollaboration" attribute.
     */
  public String getBinaryCollaboration()
  {
    return binaryCollaboration.getValue();
  }
  ...
  /**
     ...
     * @param value    New value.
     */
  public void setBinaryCollaboration(String value_)
  {
    binaryCollaboration.setValue(value_);
  }
             ...
             throws GWFException
  {
     ...
     */
    BpssCollaborationActivity bpssCollAct = new BpssCollaborationActivity();
    bpssCollAct.setActivityName(this.getName());
    //incomplete.put(this, bpssCollAct);
    try
    {
      AbstractEntityHandler handler = EntityHandlerFactory.getHandlerFor(
                                          BpssCollaborationActivity.ENTITY_NAME, 
                                          true);
      bpssCollAct = (BpssCollaborationActivity)handler.createEntity(
                        bpssCollAct);
      incomplete.put(this, bpssCollAct); //NSL20051111 Put the one with UID
      
      BpssProcessSpecEntry bpssProcSpecEntry = new BpssProcessSpecEntry();
      bpssProcSpecEntry.setSpecUId(specUId);
      bpssProcSpecEntry.setEntryName(bpssCollAct.getActivityName());
      bpssProcSpecEntry.setEntryType(bpssCollAct.getEntityName());
      bpssProcSpecEntry.setEntryUId(bpssCollAct.getUId());
    ...
    catch (Throwable th)
    {
      ...
      System.out.println("Unable to deploy " + bpssCollAct.getEntityName());
      th.printStackTrace();
  ...
  /**
   * Unmarshals the specified "CollaborationActivity" element back to a CollaborationActivity object.
   */
  public CollaborationActivity buildModel(GNElement elem)
  {
  	if (elem == null)
      return null;
      ...
      /** Unmarshals "toAuthorizedRoleIDRef" attribute */
  		super.setAttributeValue(toAuthorizedRoleIDRef, elem.getAttribute(
                                                                    "toAuthorizedRoleIDRef"));
      
      /** Unmarshals "fromAuthorizedRole" attribute */
  		super.setAttributeValue(fromAuthorizedRole, elem.getAttribute("fromAuthorizedRole"));
      
      /** Unmarshals "binaryCollaborationIDRef" attribute */
  		super.setAttributeValue(binaryCollaborationIDRef, elem.getAttribute("binaryCollaborationIDRef"));
      ...
      /** Unmarshals "binaryCollaboration" attribute */
  		super.setAttributeValue(binaryCollaboration, elem.getAttribute("binaryCollaboration"));
  ...
  public GNElement buildElement()
  {
    ...
    /** Marshals "binaryCollaborationIDRef" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_IMPLIED, binaryCollaborationIDRef);
    ...
    /** Marshals "binaryCollaboration" attribute */
  	addAttributeToElement(elem, this._ATTR_DEFAULT_REQUIRED, binaryCollaboration);
