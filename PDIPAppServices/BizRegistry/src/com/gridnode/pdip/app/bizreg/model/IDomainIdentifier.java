 ...
 * 9 Dec 2005     SC                  Add DOMAIN_NAME and TYPE for star fish no.
...
public interface IDomainIdentifier
{
  ...
  public static final Number DOMAIN_NAME = new Integer(1);
  
  public static final Number TYPE = new Integer(2);
  
  public static final Number VALUE = new Integer(3);
  
  public static final Number BUSINESS_ENTITY_UID = new Integer(4);
