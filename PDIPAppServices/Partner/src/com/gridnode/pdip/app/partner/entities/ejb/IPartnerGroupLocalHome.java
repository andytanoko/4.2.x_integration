 ...
 *
 * File: IPartnerGroupLocalHome.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
...
public interface IPartnerGroupLocalHome extends EJBLocalHome
{
  /**
   ...
   */
  public IPartnerGroupLocalObj create(IEntity entity)
   ...
   */
  public IPartnerGroupLocalObj findByPrimaryKey(Long primaryKey)
