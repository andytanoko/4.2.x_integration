 ...
 *
 * File: IPartnerTypeLocalHome.java
 *
 ****************************************************************************
 * Date           Author              Changes
 ****************************************************************************
...
public interface IPartnerTypeLocalHome extends EJBLocalHome
{
  /**
   ...
   */
  public IPartnerTypeLocalObj create(IEntity entity)
   ...
   */
  public IPartnerTypeLocalObj findByPrimaryKey(Long primaryKey)
