...
public interface IGWFRtActivityHome extends EJBHome {

    public IGWFRtActivityObj create(IEntity data)
    throws CreateException,RemoteException;

    public IGWFRtActivityObj findByPrimaryKey(Long primaryKey)
