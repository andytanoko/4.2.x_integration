...
public class BpssResponderExSignalTestCase extends TestCase
{
    static int pindex=0;
    ...
    public BpssResponderExSignalTestCase(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(BpssResponderExSignalTestCase.class);
    }
    ...
    public void testSleepUntilReqDoc() throws Exception
    {
        ...
        for(int i=0;i<6;i++){
            ...
            if(prop!=null){
                deleteFile(docPropFileName);
                wfClient.insertSignal(prop.getProperty(IBpssConstants.DOCUMENTID),IBpssConstants.EXCEPTION_SIGNAL,"Received invalid document","COMPANY-B");
                break;
            }
        }
