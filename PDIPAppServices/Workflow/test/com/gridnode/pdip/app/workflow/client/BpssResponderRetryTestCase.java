...
public class BpssResponderRetryTestCase extends TestCase
{
    static int pindex=0;
    ...
    public BpssResponderRetryTestCase(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(BpssResponderRetryTestCase.class);
    }
    ...
    public void testSleepUntilReqDoc() throws Exception
    {
        ...
        for(int c=0;c<2;c++){
            ...
            if(c==0){
                Logger.log("Resend the request document");
                String requestDocObject="This PO123 request Document";
                wfClient.insertDocument(docId,"PO123",requestDocObject,"COMPANY-A","COMPANY-A",IBpssConstants.PARTNER_CONSTANT);
            }
        }
        ...
        Logger.log("waiting for next BTA,TimeToPerform");
