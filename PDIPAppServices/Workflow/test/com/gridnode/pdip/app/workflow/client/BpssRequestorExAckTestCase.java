...
public class BpssRequestorExAckTestCase extends TestCase
{
    static int pindex=0;
    ...
    public BpssRequestorExAckTestCase(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(BpssRequestorExAckTestCase.class);
    }
    ...
    public void testSleepUntilReqDoc() throws Exception
    {
        ...
        System.out.println("Waiting for Exception TimeTo ACK Signal ");
        prop=null;
        for(int i=0;i<5;i++){
            System.out.println("Checking count = "+i);
