...
public class BpssRequestorRetryTestCase extends TestCase
{
    static int pindex=0;
    ...
    public BpssRequestorRetryTestCase(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(BpssRequestorRetryTestCase.class);
    }
    ...
    {   boolean checkRetry=true;
        ...
        for(int i=0;i<5;i++){
            ...
            if(prop!=null){
                ...
                int rc=Integer.parseInt(prop.getProperty(IBpssConstants.RETRY_COUNT));
                assertEquals("Retry value not > 1, prop="+prop,true,rc>1);
                processRequestDocument(prop.getProperty(IBpssConstants.DOCUMENTID),prop.getProperty(IBpssConstants.DOCUMENT_TYPE),prop.getProperty(IBpssConstants.DOCUMENT_OBJECT),prop.getProperty(IBpssConstants.PARTNER_KEY));
                break;
            }
        }
