...
public class BpssResponderExPerformTestCase extends TestCase
{
    static int pindex=0;
    ...
    public BpssResponderExPerformTestCase(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(BpssResponderExPerformTestCase.class);
    }
    ...
    public void testSleepUntilReqDoc() throws Exception
    {
        ...
        Thread.currentThread().sleep(40*1000);        //time to perform
        ...
        assertNotNull("Did not send Exception TimeTo Perform Signal ",prop);
    }
