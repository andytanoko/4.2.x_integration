 ...
 * Date           Author              Changes
 ****************************************************************************
 * Feb 05 2004    Neo Sok Lay         Created
...
/**
 * This class handles the logging for the ServiceMgmt module.
 *
 * @author Neo Sok Lay
 *
 * @version GT 4.0 VAN
...
public class Logger
{
  private static final String CATEGORY_MAIN = "APP.SVCMGMT";

  private static final String[] PROFILE_FACADE =  {
                                                    CATEGORY_MAIN + ".MGR",
                                                    "ServiceMgmtManagerBean",
                                                  };
  ...
  /**
   * Get the FacadeLogger for the ServiceMgmt facade.
   */
